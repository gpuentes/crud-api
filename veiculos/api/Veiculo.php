    ...
    class Veiculo extends valida {
        ...
        public function add() {
            ...
            if($this->execSQL($insert)) {
                echo json_encode("Novo item adicionado com sucesso");
                http_response_code(200);
                return;
            } else {
                echo json_encode("Tivemos um problema ao adicionar o itens");
        ...
        public function delete() {
            ...
            if($this->execSQL($delete)) {
                echo json_encode("O item foi excluído");
                http_response_code(200);
            } else {
                echo json_encode("Tivemos um problema ao excluir o itens");
                http_response_code(500);
            }
        }
